...
root_agent = Agent(
    ...
    description="""
    A friendly, accuracy-focused personal finance assistant that answers money questions
    ...
    The assistant compares scenarios side-by-side, explains formulas in plain English,
